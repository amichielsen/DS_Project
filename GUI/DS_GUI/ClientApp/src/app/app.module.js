...
var fetch_files_component_1 = require("./fetch-files/fetch-files.component");
    ...
    AppModule = __decorate([
        (0, core_1.NgModule)({
            declarations: [
                ...
                fetch_files_component_1.FetchFilesComponent
            ],
            imports: [
                ...
                router_1.RouterModule.forRoot([
                    ...
                    { path: 'fetch-files', component: fetch_files_component_1.FetchFilesComponent },
                ])
            ],
            providers: [],
